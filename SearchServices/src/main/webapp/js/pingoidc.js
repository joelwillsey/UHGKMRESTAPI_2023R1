...
$.fn.ssoLoginService = function() {
	...
	if (basicLogin == 'true'){
		...
		window.document.location = "/searchservices/login.html";
		return;
	}
	...
	if ($.fn.isUserAuthenticated()){
		...
		log('No AuthToken found redirecting to /searchservices/km/ping/login');
		window.document.location = "/searchservices/km/ping/login";
	}
