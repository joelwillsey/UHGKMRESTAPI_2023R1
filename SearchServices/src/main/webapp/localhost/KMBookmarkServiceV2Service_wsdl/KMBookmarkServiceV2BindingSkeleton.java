...
public class KMBookmarkServiceV2BindingSkeleton implements localhost.KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2PortType, org.apache.axis.wsdl.Skeleton {
    private localhost.KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2PortType impl;
    ...
    */
    ...
    public KMBookmarkServiceV2BindingSkeleton() {
        this.impl = new localhost.KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2BindingImpl();
    }

    public KMBookmarkServiceV2BindingSkeleton(localhost.KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2PortType impl) {
        this.impl = impl;
    }
    ...
    {
        localhost.KMBookmarkServiceV2Service_wsdl.ManageBookmarksV2ResponseBodyType ret = impl.manageBookmarksV2(body);
        return ret;
    }
    ...
    {
        localhost.KMBookmarkServiceV2Service_wsdl.ListAllBookmarksV2ResponseBodyType ret = impl.listAllBookmarksV2(body);
        return ret;
    }
    ...
    {
        localhost.KMBookmarkServiceV2Service_wsdl.GetBookmarkResponseBodyType ret = impl.getBookmark(body);
        return ret;
    }
    ...
    {
        localhost.KMBookmarkServiceV2Service_wsdl.GetFolderResponseBodyType ret = impl.getFolder(body);
        return ret;
    }
    ...
    {
        localhost.KMBookmarkServiceV2Service_wsdl.ReorderBookmarkAndFolderResponseBodyType ret = impl.reorderBookmarkAndFolder(body);
        return ret;
    }
