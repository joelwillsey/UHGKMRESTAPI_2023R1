...
public class ReorderBookmarkAndFolderResponseBodyType  implements java.io.Serializable {
    private localhost.KMBookmarkServiceV2Service_wsdl.ErrorMessage[] errorList;

    private boolean toReturn;

    private localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 newTree;

    public ReorderBookmarkAndFolderResponseBodyType() {
    }

    public ReorderBookmarkAndFolderResponseBodyType(
           localhost.KMBookmarkServiceV2Service_wsdl.ErrorMessage[] errorList,
           boolean toReturn,
           localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 newTree) {
     ...
     * @return errorList
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.ErrorMessage[] getErrorList() {
        return errorList;
    }
     ...
     * @param errorList
     */
    public void setErrorList(localhost.KMBookmarkServiceV2Service_wsdl.ErrorMessage[] errorList) {
        this.errorList = errorList;
    }
     ...
     * @return newTree
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 getNewTree() {
        return newTree;
    }
     ...
     * @param newTree
     */
    public void setNewTree(localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 newTree) {
        this.newTree = newTree;
    }
