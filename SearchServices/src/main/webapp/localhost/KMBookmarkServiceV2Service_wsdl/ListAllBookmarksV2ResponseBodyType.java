...
public class ListAllBookmarksV2ResponseBodyType  implements java.io.Serializable {
    private localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 response;

    public ListAllBookmarksV2ResponseBodyType() {
    }

    public ListAllBookmarksV2ResponseBodyType(
           localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 response) {
     ...
     * @return response
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 getResponse() {
        return response;
    }
     ...
     * @param response
     */
    public void setResponse(localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 response) {
        this.response = response;
    }
