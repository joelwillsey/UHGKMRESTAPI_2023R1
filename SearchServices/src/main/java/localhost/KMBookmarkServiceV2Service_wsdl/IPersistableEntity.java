...
public class IPersistableEntity  implements java.io.Serializable {
    private localhost.KMBookmarkServiceV2Service_wsdl.IAssociationList associationList;

    private localhost.KMBookmarkServiceV2Service_wsdl.IEntityLock entityLock;

    public IPersistableEntity() {
    }

    public IPersistableEntity(
           localhost.KMBookmarkServiceV2Service_wsdl.IAssociationList associationList,
           localhost.KMBookmarkServiceV2Service_wsdl.IEntityLock entityLock) {
     ...
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.IAssociationList getAssociationList() {
        return associationList;
    }
     ...
     */
    public void setAssociationList(localhost.KMBookmarkServiceV2Service_wsdl.IAssociationList associationList) {
        this.associationList = associationList;
    }
     ...
     * @return entityLock
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.IEntityLock getEntityLock() {
        return entityLock;
    }
     ...
     * @param entityLock
     */
    public void setEntityLock(localhost.KMBookmarkServiceV2Service_wsdl.IEntityLock entityLock) {
        this.entityLock = entityLock;
    }
