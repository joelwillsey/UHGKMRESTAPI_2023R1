...
public class ContentBookmarksV2  extends localhost.KMBookmarkServiceV2Service_wsdl.ContentBookmark  implements java.io.Serializable {
    private localhost.KMBookmarkServiceV2Service_wsdl.BookmarkFolderContents[] folders;

    private localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] bookmarks;
    ...
    public ContentBookmarksV2(
           ...
           localhost.KMBookmarkServiceV2Service_wsdl.BookmarkFolderContents[] folders,
           localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] bookmarks) {
        super(
            synopsis,
            bookmarkOwnerTypeId,
            typeSystemName,
     ...
     * @return folders
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.BookmarkFolderContents[] getFolders() {
        return folders;
    }
     ...
     * @param folders
     */
    public void setFolders(localhost.KMBookmarkServiceV2Service_wsdl.BookmarkFolderContents[] folders) {
        this.folders = folders;
    }
     ...
     * @return bookmarks
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] getBookmarks() {
        return bookmarks;
    }
     ...
     * @param bookmarks
     */
    public void setBookmarks(localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] bookmarks) {
        this.bookmarks = bookmarks;
    }
