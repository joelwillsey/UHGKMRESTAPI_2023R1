...
public class BookmarkFolderContent  implements java.io.Serializable {
    private localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] bookmarkedContentList;
    ...
    public BookmarkFolderContent(
           localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] bookmarkedContentList,
     ...
     */
    public localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] getBookmarkedContentList() {
        return bookmarkedContentList;
    }
     ...
     */
    public void setBookmarkedContentList(localhost.KMBookmarkServiceV2Service_wsdl.BookmarkedContentV2[] bookmarkedContentList) {
        this.bookmarkedContentList = bookmarkedContentList;
    }
