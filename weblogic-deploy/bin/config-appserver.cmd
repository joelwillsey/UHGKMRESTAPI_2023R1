...
echo.
echo Command is: java %JAVA_WLST_OPTIONS% weblogic.WLST ..\scripts\configure-general-settings.py
echo.

java %JAVA_WLST_OPTIONS% weblogic.WLST ..\scripts\configure-general-settings.py
...
echo Missing wlst environment setup script - %KM_WLS_HOME%/server/bin/setWLSEnv.cmd
