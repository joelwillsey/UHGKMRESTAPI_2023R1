...
export KM_STARTUP_OPTIONS= -Denvironment.name=local -DconfigLocation=/app_2/verint/em/projects/uhg/KMRestAPI/kmservices/config -Dmachine.name=localhost -Dcontainer.name=test -DlogFile=/app_2/verint/em/logs
