...
$.fn.ssoLoginService = function() {
	...
	if (basicLogin == 'true'){
		...
		window.document.location = "/contentservices/login.html";
		return;
	}
	...
	if ($.fn.isUserAuthenticated()){
		...
		log('No AuthToken found redirecting to /contentservices/km/ping/login');
		window.document.location = "/contentservices/km/ping/login";
	}
