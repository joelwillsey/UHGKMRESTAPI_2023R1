 ...
 *
 */
public class KmServicesBasicAuthenticationFilter extends OncePerRequestFilter {
	private final Logger LOGGER = LoggerFactory.getLogger(KmServicesBasicAuthenticationFilter.class);
	 ...
	 * 
	 */
	public KmServicesBasicAuthenticationFilter() {
		super();
		LOGGER.info("Entering KmServicesBasicAuthenticationFilter()");
		LOGGER.info("Exiting KmServicesBasicAuthenticationFilter()");
	}
	 ...
	 */
	public KmServicesBasicAuthenticationFilter(AuthenticationManager authenticationManager) {
		super();
		LOGGER.info("Entering KmServicesBasicAuthenticationFilter()");
