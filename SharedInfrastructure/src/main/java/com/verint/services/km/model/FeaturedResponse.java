...
@XmlRootElement(name = "FeaturedResponse")
@XmlAccessorType(XmlAccessType.NONE)
public class FeaturedResponse implements Serializable {
	...
	public String toString() {
		return "FeaturedResponse [knowledgeGroupUnits=" + knowledgeGroupUnits + ", suggestedQueries="
				+ suggestedQueries + "]";
	}
}
