 ...
 *
 */
public class KmPingOIDCAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(KmPingOIDCAuthenticationSuccessHandler.class);
