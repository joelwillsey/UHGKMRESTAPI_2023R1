...
public class SuggestedQuery  implements java.io.Serializable {
    ...
    private ReplacedTerm[] replacedTermsList;
    ...
    public SuggestedQuery(
           ...
           ReplacedTerm[] replacedTermsList,
     ...
     */
    public ReplacedTerm[] getReplacedTermsList() {
        return replacedTermsList;
    }
     ...
     */
    public void setReplacedTermsList(ReplacedTerm[] replacedTermsList) {
        this.replacedTermsList = replacedTermsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/FeaturedV1Service.wsdl", "SuggestedQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/FeaturedV1Service.wsdl", "ReplacedTerm"));
        elemField.setNillable(false);
