...
public class SuggestedQuery  implements java.io.Serializable {
     ...
     */
    public com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.ReplacedTerm[] getReplacedTermsList() {
        return replacedTermsList;
    }
     ...
     */
    public void setReplacedTermsList(com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.ReplacedTerm[] replacedTermsList) {
        this.replacedTermsList = replacedTermsList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/NewOrChangedV1Service.wsdl", "SuggestedQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/NewOrChangedV1Service.wsdl", "ReplacedTerm"));
        elemField.setNillable(false);
