/**
 * GetAllTagSetResponseBodyType.java
 *
...
public class GetAllTagSetResponseBodyType  implements java.io.Serializable {
    private com.kana.contactcentre.services.model.TagV1Service_wsdl.TagDescriptor[] tagDescriptors;

    public GetAllTagSetResponseBodyType() {
    }
    ...
    /**
     * Gets the tagDescriptors value for this GetAllTagSetResponseBodyType.
     * 
    ...
    /**
     * Sets the tagDescriptors value for this GetAllTagSetResponseBodyType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAllTagSetResponseBodyType)) return false;
        GetAllTagSetResponseBodyType other = (GetAllTagSetResponseBodyType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAllTagSetResponseBodyType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/TagV1Service.wsdl", "GetAllTagSetResponseBodyType"));
