...
public class LoginUserResponseBodyType  implements java.io.Serializable {
    private com.kana.contactcentre.services.model.LoginV2Service_wsdl.LoginResponse loginResponse;

    public LoginUserResponseBodyType() {
    }

    public LoginUserResponseBodyType(
           com.kana.contactcentre.services.model.LoginV2Service_wsdl.LoginResponse loginResponse) {
     ...
     */
    public com.kana.contactcentre.services.model.LoginV2Service_wsdl.LoginResponse getLoginResponse() {
        return loginResponse;
    }
     ...
     * @param loginResponse
     */
    public void setLoginResponse(com.kana.contactcentre.services.model.LoginV2Service_wsdl.LoginResponse loginResponse) {
        this.loginResponse = loginResponse;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost:80/LoginV2Service.wsdl", "LoginUserResponseBodyType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("loginResponse");
        elemField.setXmlName(new javax.xml.namespace.QName("", "loginResponse"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost:80/LoginV2Service.wsdl", "LoginResponse"));
