...
public class KnowledgeResultSet  implements java.io.Serializable {
    private KnowledgeGroupUnit[] knowledgeGroupUnits;

    private java.math.BigInteger numberOfResults;

    private SuggestedQuery[] suggestedQueryList;

    public KnowledgeResultSet() {
    }

    public KnowledgeResultSet(
           KnowledgeGroupUnit[] knowledgeGroupUnits,
           java.math.BigInteger numberOfResults,
           SuggestedQuery[] suggestedQueryList) {
     ...
     */
    public KnowledgeGroupUnit[] getKnowledgeGroupUnits() {
        return knowledgeGroupUnits;
    }
     ...
     */
    public void setKnowledgeGroupUnits(KnowledgeGroupUnit[] knowledgeGroupUnits) {
        this.knowledgeGroupUnits = knowledgeGroupUnits;
    }
     ...
     */
    public SuggestedQuery[] getSuggestedQueryList() {
        return suggestedQueryList;
    }
     ...
     */
    public void setSuggestedQueryList(SuggestedQuery[] suggestedQueryList) {
        this.suggestedQueryList = suggestedQueryList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/FeaturedV1Service.wsdl", "KnowledgeResultSet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/FeaturedV1Service.wsdl", "KnowledgeGroupUnit"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/FeaturedV1Service.wsdl", "SuggestedQuery"));
        elemField.setNillable(false);
