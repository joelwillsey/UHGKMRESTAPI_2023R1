/**
 * ManageBookmarkResponseBodyType.java
 *
...
public class ManageBookmarkResponseBodyType  implements java.io.Serializable {
    private com.kana.contactcentre.services.model.KMBookmarkServiceV1Service_wsdl.ErrorMessage[] errorList;

    public ManageBookmarkResponseBodyType() {
    }
    ...
    /**
     * Gets the errorList value for this ManageBookmarkResponseBodyType.
     * 
     * @return errorList
     */
    ...
    /**
     * Sets the errorList value for this ManageBookmarkResponseBodyType.
     * 
     * @param errorList
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ManageBookmarkResponseBodyType)) return false;
        ManageBookmarkResponseBodyType other = (ManageBookmarkResponseBodyType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ManageBookmarkResponseBodyType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/KMBookmarkServiceV1Service.wsdl", "ManageBookmarkResponseBodyType"));
