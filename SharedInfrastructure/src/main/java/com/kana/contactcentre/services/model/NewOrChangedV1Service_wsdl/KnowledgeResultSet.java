...
public class KnowledgeResultSet  implements java.io.Serializable {
    private com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.KnowledgeGroupUnit[] knowledgeGroupUnits;

    private java.math.BigInteger numberOfResults;

    private com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.SuggestedQuery[] suggestedQueryList;

    public KnowledgeResultSet() {
    }

    public KnowledgeResultSet(
           com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.KnowledgeGroupUnit[] knowledgeGroupUnits,
           java.math.BigInteger numberOfResults,
           com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.SuggestedQuery[] suggestedQueryList) {
     ...
     */
    public com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.KnowledgeGroupUnit[] getKnowledgeGroupUnits() {
        return knowledgeGroupUnits;
    }
     ...
     */
    public void setKnowledgeGroupUnits(com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.KnowledgeGroupUnit[] knowledgeGroupUnits) {
        this.knowledgeGroupUnits = knowledgeGroupUnits;
    }
     ...
     */
    public com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.SuggestedQuery[] getSuggestedQueryList() {
        return suggestedQueryList;
    }
     ...
     */
    public void setSuggestedQueryList(com.kana.contactcentre.services.model.NewOrChangedV1Service_wsdl.SuggestedQuery[] suggestedQueryList) {
        this.suggestedQueryList = suggestedQueryList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/NewOrChangedV1Service.wsdl", "KnowledgeResultSet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/NewOrChangedV1Service.wsdl", "KnowledgeGroupUnit"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.services.contactcentre.kana.com/NewOrChangedV1Service.wsdl", "SuggestedQuery"));
        elemField.setNillable(false);
