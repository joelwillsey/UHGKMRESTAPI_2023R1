...
public class KMBookmarkServiceV2ServiceLocator extends org.apache.axis.client.Service implements KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2Service {
 ...
 */
    ...
    public KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2PortType getKMBookmarkServiceV2Port() throws javax.xml.rpc.ServiceException {
    ...
    public KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2PortType getKMBookmarkServiceV2Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2BindingStub _stub = new KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2BindingStub _stub = new KMBookmarkServiceV2Service_wsdl.KMBookmarkServiceV2BindingStub(new java.net.URL(KMBookmarkServiceV2Port_address), this);
                _stub.setPortName(getKMBookmarkServiceV2PortWSDDServiceName());
                return _stub;
            }
        }
