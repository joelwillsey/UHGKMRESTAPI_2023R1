...
public class ContentBookmark  implements java.io.Serializable {
    ...
    private KMBookmarkServiceV2Service_wsdl.IEvaId bookmarkOwnerTypeId;
    ...
    private KMBookmarkServiceV2Service_wsdl.EIContentType contentType;

    private KMBookmarkServiceV2Service_wsdl.IEvaId bookmarkOwnerId;

    private KMBookmarkServiceV2Service_wsdl.IPersistableEntity bookmarkOwner;

    private java.util.Date createdDate;

    private KMBookmarkServiceV2Service_wsdl.IEvaId contentTypeId;
     ...
     */
    public KMBookmarkServiceV2Service_wsdl.IEvaId getBookmarkOwnerTypeId() {
        return bookmarkOwnerTypeId;
    }
     ...
     */
    public void setBookmarkOwnerTypeId(KMBookmarkServiceV2Service_wsdl.IEvaId bookmarkOwnerTypeId) {
        this.bookmarkOwnerTypeId = bookmarkOwnerTypeId;
    }
     ...
     * @return contentType
     */
    public KMBookmarkServiceV2Service_wsdl.EIContentType getContentType() {
        return contentType;
    }
     ...
     * @param contentType
     */
    public void setContentType(KMBookmarkServiceV2Service_wsdl.EIContentType contentType) {
        this.contentType = contentType;
    }
     ...
     */
    public KMBookmarkServiceV2Service_wsdl.IEvaId getBookmarkOwnerId() {
        return bookmarkOwnerId;
    }
     ...
     */
    public void setBookmarkOwnerId(KMBookmarkServiceV2Service_wsdl.IEvaId bookmarkOwnerId) {
        this.bookmarkOwnerId = bookmarkOwnerId;
    }
     ...
     */
    public KMBookmarkServiceV2Service_wsdl.IPersistableEntity getBookmarkOwner() {
        return bookmarkOwner;
    }
     ...
     * @param bookmarkOwner
     */
    public void setBookmarkOwner(KMBookmarkServiceV2Service_wsdl.IPersistableEntity bookmarkOwner) {
        this.bookmarkOwner = bookmarkOwner;
    }
     ...
     */
    public KMBookmarkServiceV2Service_wsdl.IEvaId getContentTypeId() {
        return contentTypeId;
    }
     ...
     * @param contentTypeId
     */
    public void setContentTypeId(KMBookmarkServiceV2Service_wsdl.IEvaId contentTypeId) {
        this.contentTypeId = contentTypeId;
    }
