...
public class ReorderBookmarkAndFolderResponseBodyType  implements java.io.Serializable {
    private KMBookmarkServiceV2Service_wsdl.ErrorMessage[] errorList;

    private boolean toReturn;

    private KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 newTree;

    public ReorderBookmarkAndFolderResponseBodyType() {
    }

    public ReorderBookmarkAndFolderResponseBodyType(
           KMBookmarkServiceV2Service_wsdl.ErrorMessage[] errorList,
           boolean toReturn,
           KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 newTree) {
     ...
     * @return errorList
     */
    public KMBookmarkServiceV2Service_wsdl.ErrorMessage[] getErrorList() {
        return errorList;
    }
     ...
     * @param errorList
     */
    public void setErrorList(KMBookmarkServiceV2Service_wsdl.ErrorMessage[] errorList) {
        this.errorList = errorList;
    }
     ...
     * @return newTree
     */
    public KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 getNewTree() {
        return newTree;
    }
     ...
     * @param newTree
     */
    public void setNewTree(KMBookmarkServiceV2Service_wsdl.ContentBookmarksV2 newTree) {
        this.newTree = newTree;
    }
