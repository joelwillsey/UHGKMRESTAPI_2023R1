...
public class GetBookmarkResponseBodyType  implements java.io.Serializable {
    private KMBookmarkServiceV2Service_wsdl.BookmarkFolderContent returnFolder;

    public GetBookmarkResponseBodyType() {
    }

    public GetBookmarkResponseBodyType(
           KMBookmarkServiceV2Service_wsdl.BookmarkFolderContent returnFolder) {
     ...
     * @return returnFolder
     */
    public KMBookmarkServiceV2Service_wsdl.BookmarkFolderContent getReturnFolder() {
        return returnFolder;
    }
     ...
     * @param returnFolder
     */
    public void setReturnFolder(KMBookmarkServiceV2Service_wsdl.BookmarkFolderContent returnFolder) {
        this.returnFolder = returnFolder;
    }
