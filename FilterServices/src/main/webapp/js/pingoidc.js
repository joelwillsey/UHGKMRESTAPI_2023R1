...
$.fn.ssoLoginService = function() {
	...
	if (basicLogin == 'true'){
		...
		window.document.location = "/filterservices/login.html";
		return;
	}
	...
	if ($.fn.isUserAuthenticated()){
		...
		log('No AuthToken found redirecting to /filterservices/km/ping/login');
		window.document.location = "/filterservices/km/ping/login";
	}
